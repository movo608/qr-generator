...
$this->registerLinkTag(['rel' => 'stylesheet', 'href' => 'https://fonts.googleapis.com/css2?family=Roboto:wght@400;700;900&display=swap']);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
...
<body class="d-flex flex-column h-100">
    ...
    <header id="header">
        ...
        if (Yii::$app->user->isGuest) {
            $navItems[] = ['label' => 'Sign Up', 'url' => ['/site/signup']];
            $navItems[] = ['label' => 'Login', 'url' => ['/site/login']];
        } else {
            $navItems[] = ['label' => 'QR Codes', 'url' => ['/qrcode/default/index']];
    ...
    <footer id="footer" class="mt-auto py-3 bg-light">
        <div class="container">
            <div class="row text-muted">
                ...
                <div class="col-md-6 text-center text-md-end">Built by Sollenium.</div>
            </div>
        </div>
    </footer>
